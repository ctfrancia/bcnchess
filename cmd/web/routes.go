...
func (app *application) routes() http.Handler {
	...
	mux.Post("/api/tournament/create", dynamicMiddleware.Append(app.requireAuthentication).ThenFunc(app.createTournament))

	mux.Get("/api/tournament/:id", dynamicMiddleware.ThenFunc(app.showTournament))
